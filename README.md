...
**Version 2.7.2** · Compatible EDOF 2026 · Format LHEO 2.4
...
📥 **Téléchargement** : [dernière version (v2.7.2)](https://github.com/ericfalcon/editeur-LHEO/releases/latest) · [toutes les versions](https://github.com/ericfalcon/editeur-LHEO/releases)
